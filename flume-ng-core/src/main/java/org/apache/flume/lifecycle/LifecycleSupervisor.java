...
public class LifecycleSupervisor implements LifecycleAware {
    ...
    public synchronized void supervise(LifecycleAware lifecycleAware,
        ...
        /**
         * 一般情况下 Source、Channel 和 Sink 组件启动的策略都是 AlwaysRestartPolicy
         */
        process.policy = policy;
        /**
         * 一般情况下 Source、Channel 和 Sink 组件启动的状态都是 START
         */
        ...
        /**
         * 具体的组件 比如 SyslogUDPSource、MemoryChannel、KafkaSink
         */
        ...
        /**
         * 执行启动组件 一般情况下 先启动 Channel、Sink、最后启动 Source
         *
         */
    ...
    public static class MonitorRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (lifecycleAware) {
                    /**
                     * 正常情况下 执行启动组件的时候 discard = false, error = false
                     */
